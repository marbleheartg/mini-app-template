...
export async function GET() {
  return NextResponse.json({
    miniapp: {
      version: "1",
      name: MINIAPP_TITLE,
      iconUrl: `https://${NEXT_PUBLIC_HOST}/images/og/manifest/icon.png`,
      ...
      screenshotUrls: [
        ...
        `https://${NEXT_PUBLIC_HOST}/images/og/manifest/screenshots/2.jpg`,
        `https://${NEXT_PUBLIC_HOST}/images/og/manifest/screenshots/3.jpg`,
      ],
